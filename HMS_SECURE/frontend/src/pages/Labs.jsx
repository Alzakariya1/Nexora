...
export default function Labs({ lab, setLab, addLab, labs = [], labTemplates = [], createLabTemplate, saveLabResults, approveLabReport, archiveLabOrder, rad, setRad, addRadiology, rads = [], patients = [], doctors = [], updateLabStatus, uploadLabReport, updateRadiologyStatus, uploadRadiologyReport, saveRadiologyReport, approveRadiologyReport, archiveRadiologyOrder, permissions = {} }) {
