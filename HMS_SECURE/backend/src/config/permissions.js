const ROLE_PERMISSIONS = {
  ...
  admin: [
    ...
    'billing.view', 'billing.create', 'billing.edit', 'insurance.view', 'insurance.manage', 'erp.view', 'erp.manage',
  ...
  accountant: [
    'dashboard.view', 'billing.view', 'billing.create', 'billing.edit', 'insurance.view', 'insurance.manage', 'erp.view', 'erp.manage',
    'admin.profile.manage', 'notification.view', 'communication.view',
  ],
  patient: [
...
const PERMISSION_GROUPS = {
  ...
  billing_insurance: ['billing.view', 'billing.create', 'billing.edit', 'insurance.view', 'insurance.manage', 'erp.view', 'erp.manage'],
